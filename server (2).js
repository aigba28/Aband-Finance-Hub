...
const info=await transport.t.sendMail(mailOpts);
r.json({success:true,messageId:info.messageId})}
catch(e){console.error("Email error:",e.message);r.status(500).json({error:"Failed to send: "+e.message})}});
